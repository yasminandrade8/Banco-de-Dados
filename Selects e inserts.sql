...
DELETE FROM Entregas WHERE idEntrega = 510;


ALTER TABLE Entregas MODIFY COLUMN idEntrega INT AUTO_INCREMENT;
ALTER TABLE Motoristas MODIFY COLUMN idMotorista INT AUTO_INCREMENT;
ALTER TABLE Veiculos MODIFY COLUMN idVeiculo INT AUTO_INCREMENT;
ALTER TABLE Log_exclusoes MODIFY id INT AUTO_INCREMENT;
